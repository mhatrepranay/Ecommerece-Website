    ...
    constructor() {
        ...
        this.state = {
            ...
            selections: {
                ...
                Shape: "No combinations selected.",
                COLOR: "No combinations selected.",
                "3rd Sepc": "No combinations selected.",
                "4th Sepc": "No combinations selected.",
                "5th Sepc": "No combinations selected.",
                "6th Sepc": "No combinations selected.",
                "7th Sepc": "No combinations selected.",
                "8th Sepc": "No combinations selected.",
            },
        };
    }
        ...
        productservice.getAllProduct().then((res) => {
            ...
            const productsoptions = this.generateOptions(
                ...
                Array.from(uniqueProductNames).map((name) =>
                    res.data.find((product) => product.productName.toLowerCase() === name)
                        .productName
                )
            );
                        ...
                        <div className="container my-4 ">
                            ...
                            <div className="container">
                                <div className="d-flex align-items-center">
                                    <textarea className="textar fw-bolder" value={this.state.output}></textarea>
                                    <button
